...
+ (NSDate *)lastUpdate {
    ...
    NSDate *dateValue = [[NSUserDefaults standardUserDefaults] objectForKey:FEEDUSERDEFAULTS_LASTUPDATE];
...
+ (void)setLastUpdate:(NSDate *)date {
    [[NSUserDefaults standardUserDefaults] setObject:date forKey:FEEDUSERDEFAULTS_LASTUPDATE];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
...
+ (NSString *)appleToken {
    NSString *stringValue = [[NSUserDefaults standardUserDefaults] objectForKey:FEEDUSERDEFAULTS_APPLETOKEN];
    NSString *returnValue = FEEDUSERDEFAULTS_DEFAULTAPPLETOKEN;

    if (!stringValue) {
        [[NSUserDefaults standardUserDefaults] setObject:returnValue forKey:FEEDUSERDEFAULTS_APPLETOKEN];
        [[NSUserDefaults standardUserDefaults] synchronize];
    } else {
        returnValue = stringValue;
    }
...
+ (void)setAppleToken:(NSString *)appleToken {
    [[NSUserDefaults standardUserDefaults] setObject:appleToken forKey:FEEDUSERDEFAULTS_APPLETOKEN];
}
